...
contract RaffleTest is CodeConstants, Test {
    ...
    function testDontAllowEntranceWhenRaffleCalculating() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    /* Check Upkeep */
    function testCheckUpKeepReturnsFalseIfPeopleHaveNotSentEth() public view {
    ...
    // Test to get data from emitted event
    ...
    function testFulfillRandomWordsPicksWinnerResetAndSendsMoney() public raffleEntered {
        // Arrange
